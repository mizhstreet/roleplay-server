...
// --------===<{([user Routes])}>===--------
// ___[Read]___
router.get("/api/me", Authorization.authorizationCustomer, userController.me);
router.get(
  "/api/admin/users",
...
// --------===<{([Search Routes])}>===--------
router.get("/api/search?q=:query", SearchController.searchProducts);
router.get(
  "/api/products/category/:category",
  SearchController.filterProductsByCategory
);
router.get("/api/category", SearchController.getAllCategories);
